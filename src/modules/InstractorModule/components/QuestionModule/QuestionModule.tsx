...
const onSubmit=async(data:QuestionForm)=>{
  console.log(data);
   ...
   try {
     ...
     const response=await axiosInstance.put<QuestionForm>(QUESTIONS.UPDATE_QUESTION(selectedId),data);
...
const getQuestionById=async(selectedId:string)=>{
 try {
   ...
   const response=await axiosInstance.get(QUESTIONS.GET_QUESTION_BY_ID(selectedId));
