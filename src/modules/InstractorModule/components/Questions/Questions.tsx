...
import { QUESTIONS } from "../../../../config/api.endPoint";
import type { Question } from "../../../AuthModule/type";
...
export default function Questions() {
  const[loading,setLoading]=useState(false);
       ...
       try {
         ...
         const response=await axiosInstance.get(QUESTIONS.GET_ALL_QUES);
       ...
       try {
         const response=await axiosInstance.delete(QUESTIONS.DELETE_QUESTION(id));
