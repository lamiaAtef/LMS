...
import { CONFIRM_PASSWORD_VALIDATION, EMAIL_VALIDATION, PASSWORD_VALIDATION } from '../../../../config/validation'
...
const emailFromState = location.state?.email;
  ...
  const onSubmit=async(data:ResetPayload)=>{
    setLoading(true)
    try {
      const response= await axiosInstance.post(AUTH_URLS.RESET_PASSWORD,data)
